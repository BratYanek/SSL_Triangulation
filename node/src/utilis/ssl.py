...
def inti_mics(rotation=0):
    ...
    mics[0, :] = torch.Tensor([-0.02875, -0.02875, +0.01])
    mics[1, :] = torch.Tensor([+0.02875, -0.02875, +0.01])
    mics[2, :] = torch.Tensor([+0.02875, +0.02875, +0.01])
    mics[3, :] = torch.Tensor([-0.02875, +0.02875, +0.01])
